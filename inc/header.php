...
<body class="page-<?=$page?>">
	<div id="alert">
		<p>Thank you for visiting Soncy! If you are here because of our <strong>LivingSocial promotion</strong>, please <strong>call 562-431-8000</strong> to book with Alex.</p>
	</div>
	<header>
		<div class="wrap cf">
