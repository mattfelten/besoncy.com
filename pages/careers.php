...
<div id="<?=$page?>" class="mainCol">
	...
	<p>We at Soncy are always interested in new, fresh talent. Specifically, we are looking for people with a "can do" spirit, great interpersonal skills, ability to take initiative and multi-task, a willingness to work as part of a collaborative creative team, and a desire to contribute as well as take advantage of opportunities for long term professional growth. Team members must be detailed oriented and able to offer impeccable service while having fun!</p>
	<p>If you are interested in working at Soncy and feel you are a fit with our ongoing opportunities, please come on by, introduce yourself, and experience our space. We'd be happy to meet you and show you around. Be sure to bring a copy of your resume.</p>
	...
	<p>Part-time assistant position available. Must be a licensed cosmetologist in the state of CA. Person in this position would serve as the liaison between the owner and her clients accomplishing an array of tasks including (but not limited to) booking appointments, greeting clients when they arrive, shampooing and conditioning clients' hair, and assisting with clean-up. There will also be opportunities to observe cutting techniques, color application and finish work. Must be willing to participate in ongoing educational classes as the goal would be for this person to grow into a position as hairdresser at Soncy. Hourly pay plus gratuities.</p>
